...
return [
     ...
     */
    'vapid' => [
        'subject' => env('VAPID_SUBJECT', docker_secret('VAPID_SUBJECT_FILE')),
        'public_key' => env('VAPID_PUBLIC_KEY', docker_secret('VAPID_PUBLIC_KEY_FILE')),
        'private_key' => env('VAPID_PRIVATE_KEY', docker_secret('VAPID_PRIVATE_KEY_FILE')),
        'pem_file' => env('VAPID_PEM_FILE', docker_secret('VAPID_PEM_FILE_FILE')),
    ],
