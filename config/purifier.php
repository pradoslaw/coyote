...
//    'Cache.SerializerPath'     => getenv('APP_ENV') === 'local' ? null : storage_path('app/purifier'),
    ...
    'HTML.Allowed'             => 'b,strong,i,em,a[href|title|data-user-id|class],p,br,ul,ol,li,span[style],img[width|height|alt|src|title],sub,sup,pre,code[class],kbd,h2[id],h3[id],h4[id],h5[id],h6[id],blockquote,del,table[summary],thead,tbody,tr,th[abbr],td[abbr],hr,dfn,var',
