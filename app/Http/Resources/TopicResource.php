...
class TopicResource extends JsonResource
{
    ...
    {
        $only = $this->resource->only(['id', 'title', 'slug', 'score', 'views', 'is_sticky', 'is_subscribed', 'is_locked', 'first_post_id', 'last_post_id', 'subscribers', 'accepted_id', 'is_voted', 'is_replied', 'user_name', 'user_post_id']);
