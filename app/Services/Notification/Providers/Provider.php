...
use Coyote\Services\Notification\Broadcasts\Db as Broadcast_Db;
use Coyote\Services\Notification\Broadcasts\Email as Broadcast_Email;
...
abstract class Provider implements ProviderInterface
{
     ...
     * @throws \Exception
     */
    public function __construct(NotificationRepository $repository, array $args = [])
    {
        ...
        if (!$this->headline) {
            throw new \Exception('Uuups. Could not find record in notification_types table.');
        }
    ...
    /**
     * @return \Coyote\Notification\Setting[]
     */
