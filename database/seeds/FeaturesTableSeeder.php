...
class FeaturesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Coyote\Feature::forceCreate(['name' => 'Continuous Integration', 'default' => 'Np. Jenkins, Bamboo, Travis CI']);
        \Coyote\Feature::forceCreate(['name' => 'Testy jednostkowe', 'default' => 'Np. PHPUnit, JUnit']);
        \Coyote\Feature::forceCreate(['name' => 'Testy integracyjne', 'default' => '']);
